...
const meta = {
  title: 'Components/Dropdown/DropdownItemMultiselect',
...
/** Single configurable multiselect item — click the item or use the controls panel to toggle checked, description, and disabled. */
