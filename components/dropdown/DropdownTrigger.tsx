...
const appearanceToButtonVariant = {
  emphasis: 'secondary',
  default: 'outline-secondary',
  subtle: 'ghost',
} satisfies Record<DropdownTriggerAppearance, ButtonVariant>;
...
>(function DropdownTrigger(
  ...
  if (import.meta.env.DEV) {
    ...
    if (selected && !isNavPill) {
      console.warn(
        '[MDS DropdownTrigger] `selected` is only supported on the nav-pill variant. Ignoring.',
      );
    }
  }
