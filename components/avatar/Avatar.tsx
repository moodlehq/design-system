  ...
  (
    ...
    return (
      <span
        ...
        // role="img" is required for aria-label to be valid on a <span>.
        // Only applied when the span itself carries the accessible name
        // (non-image states); the <img alt> carries the name when an image
        // is visible so no role override is needed there.
        role={spanAriaLabel ? 'img' : undefined}
