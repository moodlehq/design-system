...
| Tag             | Compact removable or link token for labelling, categorising, or representing a selected value (person or otherwise) | content, type, variant, href, onRemove, removeLabel, avatar, institution, disabled, nonRemovable, invalid — plus any extra string prop (e.g. `username`, `email`), rendered as Position 2 content |
...
- [Input implementation](../../components/input/Input.tsx)
- [Input stories](../../components/input/Input.stories.tsx)
...
- [Tag implementation](../../components/tag/Tag.tsx)
- [Tag stories](../../components/tag/Tag.stories.tsx)
